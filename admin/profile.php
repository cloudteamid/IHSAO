  ...
  <body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        ?>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="profile_update.php" method="GET" >

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Username: <span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label class="control-label  col-xs-1" for="first-name">admin<span class="required"></span>
                        </label>
                        </div>
                      </div>
                      <div class="form-group">
