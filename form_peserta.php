  ...
  <body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        ?>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="update.php" method="GET" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="gender" class="btn-group" data-toggle="buttons">
                            ...
                            <label class="btn btn-dark" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="status" value="Unverified"> Unverified
                            </label>
                          </div>
                        </div>
                      </div>
