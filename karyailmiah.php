...
<body>
  <?php
    ...
    ?>
    <?php
    $query = mysqli_query($con, "SELECT * FROM info_lomba where id_info = 8 ");
...
<main id="main">
	...
	<div class="container">
		<h2 class="section-title2"><span>KARYA ILMIAH</span></h2>
		...
		<!-- OPSI 1 -->
		<h2 class="section-title3"><span class="glyphicon glyphicon-cog" style="font-size:20px; color:#eac338"></span> Peraturan Perlombaan Karya Ilmiah</h2>
		<hr class="hr-style2"></hr>
		
			<table>
            <?php 
            $query = mysqli_query($con, "SELECT p_lomba FROM peraturan_lomba where id_info = 8 order by id_peraturan");
